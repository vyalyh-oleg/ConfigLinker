...
public @interface BoundProperty {
	 ...
	 * <p>If you set {@code @BoundObject.propertyNamePrefix} it will be added before this value, and in that case this value should begin with a dot. If it begins from any other acceptable symbols except dot, the value considered as full name and used without {@code propertyNamePrefix}.</p><br/>
	 * <p>
	 * You can use variables for substituting some parts of the name.
	 * Variables can be set in {@link com.configlinker.ConfigSetBuilder#addParameter(String, String)}.<br/>
	 * Example:
	...
	/**
	 * Delimiter for parameter value, which is treated as {@code List}. Default value is comma - {@code ','}.<br/>
	 * Example:<br/>
	...
	/**
	 * Delimiter for parameter element, which is treated as key-value pair for {@code Map}. Default value is colon - {@code ':'}.<br/>
	 * Example:<br/>
	 ...
	 * <p><b>Standard supported return types</b> (you shouldn't change current parameter for them because it will be ignored):<br/>
	 * - all primitives and arrays of primitives;<br/>
	 * - all wrappers of primitives and arrays of them;<br/>
	 * - {@code String} and {@code String[]}<br/>
	 * - {@code Enum} and {@code Enum[]}<br/>
	 * - {@code List<String>}<br/>
	 * - {@code Set<String>}<br/>
	 * - {@code Map<String,String>}<br/>
	 * <p>
	...
	/**
	 * <p>If you want to use custom return type, you must just implement deserialization logic for it (see {@link #customType()}) and point this choice here.<br/>
	 * Default value is {@link DeserializationMethod#CONSTRUCTOR_STRING}
	 * <p>If return type for you configuration method is List, Set or Map, then only {@link DeserializationMethod#CONSTRUCTOR_STRING}, {@link DeserializationMethod#VALUEOF_STRING}, {@link DeserializationMethod#DESERIALIZER_STRING} allowed as deserialization method for it's values.
	 */
	...
	enum DeserializationMethod {
		/**
		 * Chose this variant if you implement special constructor for your class:<br/>
		 * {@code 'public/private <CustomReturnType>(String raw)'}
		 */
		CONSTRUCTOR_STRING,
		/**
		 * Chose this variant if you implement special constructor for your class:<br/>
		 * {@code 'public/private <CustomReturnType>(Map<String,String> raw)'}
		 */
		CONSTRUCTOR_MAP,
		/**
		 * Chose this variant if you implement in your custom type static instance generator method:<br/>
		 * {@code 'public/private static <CustomReturnType> valueOf(String raw)'}
		 */
		VALUEOF_STRING,
		/**
		 * Chose this variant if you implement in your custom type static instance generator method:<br/>
		 * {@code 'public/private static <CustomReturnType> valueOf(Map<String,String> raw)'}
		 */
		VALUEOF_MAP,
		/**
		 * Chose this variant if you implement {@link Deserializer#deserialize(String)}.<br/>
		 */
		DESERIALIZER_STRING,
		/**
		 * Chose this variant if you implement {@link Deserializer#deserialize(Map)}.<br/>
		 */
		DESERIALIZER_MAP
		;
	}
