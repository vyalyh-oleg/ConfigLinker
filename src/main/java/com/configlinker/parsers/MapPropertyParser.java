...
final class MapPropertyParser implements PropertyParser<Map<String, String>> {
	@Override
	public Map<String, String> parse(String rawValue, boolean ignoreWhitespaces, Pattern regexpPattern, String delimiterForList, String delimiterForKeyValue) throws PropertyMatchException {
