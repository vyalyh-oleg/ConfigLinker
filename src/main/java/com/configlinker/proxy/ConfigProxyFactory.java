...
public class ConfigProxyFactory {
	...
	public static Object create(HashMap<Class<?>, ConfigDescription> mapConfigDescriptions, LoaderService loaderService)
	{
		...
		return Proxy.newProxyInstance(ConfigProxyFactory.class.getClassLoader(), configInterfaces.toArray(new Class<?>[configInterfaces.size()]), configInvocationHandler);
	}
}
