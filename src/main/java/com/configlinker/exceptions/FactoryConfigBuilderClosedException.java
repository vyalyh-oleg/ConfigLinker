...
public class FactoryConfigBuilderClosedException extends ConfigLinkerRuntimeException {
	private static final String message = "You can not change parameter or add property to closed FactoryConfigBuilder. It is closed, because it was already used in ConfigSetFactory.";
