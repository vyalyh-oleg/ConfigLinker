...
class ExtendedTypesTest extends AbstractBaseTest
{
	...
	void test_typeEnumError()
	{
		...
		Assertions.assertEquals("Cannot create object for return type in method 'net.crispcode.configlinker.tests.NumberName::valueOf'.", exception.getMessage());
		Throwable baseCause = exception.getCause().getCause();
		Assertions.assertEquals(IllegalArgumentException.class, baseCause.getClass());
		Assertions.assertEquals("No enum constant net.crispcode.configlinker.tests.NumberName.eleven", baseCause.getMessage());
	}
	...
	void test_typeInetAddressIPv4Error()
	{
		...
		Assertions.assertTrue(
			baseCause.getMessage().equals("192.256.12.10: Name or service not known")
				|| baseCause.getMessage().equals("192.256.12.10: No address associated with hostname")
		);
	}
	...
	void test_typeDateErrorMilliseconds()
	{
		...
		Assertions.assertEquals("Cannot create object for return type in method 'net.crispcode.configlinker.deserializers.DateType$Milliseconds::deserialize'.", exception.getMessage());
		Throwable baseCause = exception.getCause().getCause();
		Assertions.assertEquals(NumberFormatException.class, baseCause.getClass());
	...
	void test_typeDateErrorSeconds()
	{
		...
		Assertions.assertEquals("Cannot create object for return type in method 'net.crispcode.configlinker.deserializers.DateType$Seconds::deserialize'.", exception.getMessage());
		Throwable baseCause = exception.getCause().getCause();
		Assertions.assertEquals(NumberFormatException.class, baseCause.getClass());
	...
	void test_typeDateError()
	{
		...
		Assertions.assertEquals("Cannot create object for return type in method 'net.crispcode.configlinker.deserializers.DateType$DateTime::deserialize'.", exception.getMessage());
